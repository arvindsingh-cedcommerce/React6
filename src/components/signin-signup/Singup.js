...
export default function Singup() {
    ...
    return (
        <div sx={{ width: 1000 }} >
            <Typography sx={{ '&:hover': { color: '#f6b125' } }} onClick={handleClickOpen}>Sign Up</Typography>
            <Dialog
                open={opensignup}
            ...
            >
                <Grid container sx={{ width: 650, height: 550 }}>
                    <Grid item md={5} sx={{ backgroundColor: '#221f2d', color: 'white', justifyContent: 'center', alignItems: 'center', p: 3 }}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', margin: '6rem auto' }}>
                            <img src='images/sweetshop-logo.webp' alt='' style={{ height: 90, width: 160, paddingLeft: 19 }} />
                    ...
                    <Grid item md={7}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', marginTop: '6rem', pl: 2 }}>
                            ...
                            <Button variant='contained' sx={{ mt: 2, mr: 2, backgroundColor: '#CC9F45', '&:hover': { backgroundColor: '#B78A30' } }} onClick={Signup}>Continue</Button>
                        </Box>
                    </Grid>
                </Grid>
            </Dialog>
