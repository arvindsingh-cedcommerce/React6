...
export default function Singup() {
  ...
  return (
    <div sx={{ width: 1000 }} >
      <Typography sx={{ '&:hover': { color: '#f6b125' } }} onClick={handleClickOpen}>Log In</Typography>
      <Dialog
        open={opensignin}
        ...
        <Grid container sx={{ width: 650, height: 550 }}>
          ...
          <Grid item md={7}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', marginTop: '6rem', pl: 2 }}>
              ...
              <Button variant='contained' sx={{ mt: 2, mr: 2, backgroundColor: '#CC9F45', '&:hover': { backgroundColor: '#B78A30' } }} onClick={Signin}>Log In</Button>
            </Box>
          </Grid>
        </Grid>
      </Dialog>
