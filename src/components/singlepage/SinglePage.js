                    ...
                    <Grid container sx={{ backgroundColor: '#EBEBEB', alignContent: 'center', borderRadius: '10px', mr: 1 }}>
                      <Grid item md={5}>
                        <Button variant="contained"
                          ...
                          sx={{ background: '#ca9b3c', mt: 1, ml: 4, padding: '13px 32px', fontWeight: 'bold', '&:hover': { background: '#B27D10' } }}
                      ...
                      <Grid item md={5}>
                        <Button variant="contained"
                          ...
                          sx={{
                            background: '#ca9b3c', mt: 1, ml: 4,
                            padding: '13px 32px', fontWeight: 'bold', '&:hover': { background: '#B27D10' }
                          }}
                        >
                          Buy Now
                        </Button>
