  ...
  return (
    <>
      {productArray.length < 1 ?
        ...
        <>
          <Grid container sx={{
            backgroundColor: '#E2E2E2', mt: 11, pt: 5.5,marginBottom:6,
            width: { xs: '100%' }
          }}>
                ...
                <Paper elevation={3}>
                  ...
                  <Grid sx={{ display: "grid", placeItems: "center" }}>
                    <Button variant='outlined' startIcon={<NavigateBeforeIcon />}
                      sx={{ mt: 3, color: '#7e1717', border: '1px solid #7e1717', mb: 1, '&:hover': { color: '#fff', backgroundColor: '#7e1717', border: '1px solid #7e1717' } }} onClick={() => navi('/products')}>Continue Shoppping</Button>
                  </Grid>
                </Paper>
              </Box>
            </Grid>
